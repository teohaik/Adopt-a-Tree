  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full">
        <h2 className="text-2xl font-bold mb-4">Adopt a Tree</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
              placeholder="e.g., Oak Tree near the park"
            />
          </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            >
              {isSubmitting ? 'Submitting...' : 'Adopt Tree'}
            </button>
            <button
              type="button"
              onClick={onCancel}
        ...
        <p className="text-xs text-gray-500 mt-4">
          By adopting this tree, you agree to maintain and water it regularly. You will receive a confirmation email with the tree location.
        </p>
      </div>
    </div>
  );
