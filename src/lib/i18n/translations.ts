...
export const translations: Record<Language, Translations> = {
  el: {
    ...
    wateringGuideLink: 'Δες τον οδηγό φροντίδας δέντρων',
    ...
    // Guide page
    guideTitle: '💧 Οδηγός φροντίδας δέντρων',
    ...
    guidePruningContact: '➡️ Σε αμφιβολία, επικοινωνούμε με το ',
    guidePruningContactLink: 'τμήμα πρασίνου του Δήμου Θέρμης',
    ...
    guideContactDepartment: 'Τμήμα Πρασίνου Δήμου Θέρμης',
    guideContactHead: 'Υπεύθυνη:',
    ...
    emailWateringGuide: 'Οδηγός φροντίδας δέντρων',
  ...
  en: {
    ...
    wateringGuideLink: 'See the tree care guide',
